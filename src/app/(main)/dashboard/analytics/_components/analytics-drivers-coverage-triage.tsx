  ...
  const leverOptions = [
    {
      ...
      value: `+${formatCurrency(6200000, { noDecimals: true })} weighted`,
      context: "32% of gap",
    },
    {
      key: "conversion",
      label: "+5pp conversion",
      value: `+${formatCurrency(4200000, { noDecimals: true })}/month`,
      context: "22% of gap",
    },
    {
      key: "cycle",
      label: "-4d cycle",
      value: `+${formatCurrency(8200000, { noDecimals: true })}/day`,
      context: "40% of gap",
    },
  ] as const;
    ...
    <Card className="shadow-xs">
      ...
      <CardContent className="space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline" className="font-medium tabular-nums">
            Gap {formatCurrency(18200000, { noDecimals: true })}
          </Badge>
          <Badge variant="outline" className="font-medium tabular-nums">
            4 deals • ETA 10d
          </Badge>
