...
const RISK_SUMMARY_METRICS = [
  ...
  },
  {
    key: "risk",
    label: "Value at Risk",
    value: formatCurrency(95_93_300, { noDecimals: true }),
    comparatorLabel: "vs previous period",
  },
  {
    key: "win-rate",
    label: "Delivery Rate Trend",
    value: "+8.3pp",
    comparatorLabel: "vs previous period",
  },
  {
    ...
    <div className="grid gap-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <ExportButton data={revenueSeries} filename="analytics-report" variant="secondary" />
        </div>
      </div>
    ...
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
      <div className="min-w-0 space-y-2">
        <div>
          ...
          <div className="font-semibold text-3xl tabular-nums tracking-tight sm:text-4xl">{formatCurrency(1_04_00_000, { noDecimals: true })}</div>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <Badge variant="secondary">+9.4%</Badge>
          <Badge variant="secondary">+{formatCurrency(8_93_000, { noDecimals: true })}</Badge>
        </div>

        <div className="flex flex-wrap items-center gap-2 text-muted-foreground text-sm">
          <span>Previous {formatCurrency(95_07_000, { noDecimals: true })}</span>
