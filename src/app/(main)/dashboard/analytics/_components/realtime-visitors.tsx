...
export function RealtimeVisitors() {
	return (
		<Card className="h-full">
			<CardHeader>
				<CardTitle className="font-normal">Realtime Footfall</CardTitle>
				<CardAction>
			...
			<CardContent className="flex flex-col gap-4">
				<div className="flex items-end justify-between">
					<div className="flex items-baseline gap-1">
						...
						<span className="text-muted-foreground text-sm">visits / min</span>
					</div>
				...
				<div className="grid grid-cols-2">
					<div className="flex items-center gap-3 border-border/50 border-r border-b pt-1 pr-5 pb-4">
						<span className="size-2 rounded-full bg-chart-1 shrink-0" />
						<span className="min-w-0 flex-1 truncate text-sm">
							Smart Works Noida
						</span>
						<span className="text-sm tabular-nums font-mono font-medium">
							14
						</span>
					</div>
					<div className="flex items-center gap-3 border-border/50 border-b pt-1 pb-4 pl-5">
						<span className="size-2 rounded-full bg-chart-2 shrink-0" />
						<span className="min-w-0 flex-1 truncate text-sm">KLJ Store</span>
						<span className="text-sm tabular-nums font-mono font-medium">
							6
						</span>
					</div>
