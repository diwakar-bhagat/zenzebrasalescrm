      ...
      <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div>
                ...
                <p className="mt-2 line-clamp-3 min-h-[4.5em] text-muted-foreground text-sm">
                  Excellent checkout service at the store. The item fits perfectly and quality is premium.
                </p>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between gap-4 rounded-lg border px-4 py-3">
          <div className="min-w-0">
            <div className="font-medium text-sm">{reviewsCount.toLocaleString()} reviews</div>
            <div className="line-clamp-2 min-h-[3em] text-muted-foreground text-xs">Customer feedbacks from the sales sheet</div>
          </div>
          ...
          <AvatarGroup>
            ...
            <AvatarGroupCount>+{Math.max(0, reviewsCount - 4)}</AvatarGroupCount>
          </AvatarGroup>
        </div>
      </CardContent>
    </Card>
