        ...
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="min-w-0 flex flex-col gap-1 px-1">
              ...
              <div className="font-heading text-lg leading-none tracking-tight">{formatCurrency(3_80_000, { noDecimals: true })}</div>
            </div>
        ...
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="min-w-0 flex flex-col gap-1 px-1">
              ...
              <div className="font-heading text-lg leading-none tracking-tight">{formatCurrency(1_17_000, { noDecimals: true })}</div>
            </div>
        ...
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="min-w-0 flex flex-col gap-1 px-1">
              ...
              <div className="font-heading text-lg leading-none tracking-tight">{formatCurrency(63_700, { noDecimals: true })}</div>
            </div>
