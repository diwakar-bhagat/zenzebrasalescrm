      ...
      <div className="grid grid-cols-1 xl:grid-cols-8">
          ...
          <CardContent className="flex items-end justify-between">
            <div className="space-y-1">
              <div className="font-heading text-3xl leading-none tracking-tight">
                {formatCurrency(1_28_40_000, { noDecimals: true })}
              </div>
              <p className="text-muted-foreground text-xs">+{formatCurrency(9_80_000, { noDecimals: true })} vs last month</p>
            </div>
        ...
        <Card className="gap-5 overflow-hidden rounded-none border-0 border-foreground/10 border-b ring-0 xl:col-span-4">
          ...
          <CardContent className="flex items-end justify-between">
            <div className="flex flex-col gap-1">
              <div className="font-heading text-3xl leading-none tracking-tight">
                {formatCurrency(12_80_000, { noDecimals: true })}
              </div>
              <p className="text-muted-foreground text-xs">{formatCurrency(41_000, { noDecimals: true })} above your 30-day average</p>
            </div>
        ...
        <Card className="gap-5 overflow-hidden rounded-none border-0 border-foreground/10 ring-0 xl:col-span-4 xl:border-r">
          ...
          <CardContent className="flex items-end justify-between">
            <div className="flex flex-col gap-1">
              <div className="font-heading text-3xl leading-none tracking-tight">
                {formatCurrency(2_14_000, { noDecimals: true })}
              </div>
              <p className="text-muted-foreground text-xs">{formatCurrency(12_400, { noDecimals: true })} more than last month</p>
            </div>
