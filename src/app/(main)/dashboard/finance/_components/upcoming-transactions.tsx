        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            <h2 className="flex items-baseline text-3xl leading-none tracking-tight">
              <span className="font-normal">{formatCurrency(1_02_450, { noDecimals: true })}</span>
            </h2>
          ...
          <div className="flex w-max items-center gap-2 rounded-md border border-border bg-muted/70 px-2 py-1.5 text-sm">
            ...
            <span className="text-muted-foreground">
              Autopay will process <span className="font-medium text-foreground">{formatCurrency(12_450, { noDecimals: true })}</span> today
            </span>
          </div>
        </div>
