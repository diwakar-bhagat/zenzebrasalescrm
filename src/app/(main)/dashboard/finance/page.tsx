...
export default function Page() {
  ...
  const transactionsData = [
    { date: "2026-01-05", category: "Income", amount: 3800, type: "Credit" },
    { date: "2026-01-05", category: "Expense", amount: 2300, type: "Debit" },
    { date: "2026-01-07", category: "Income", amount: 4400, type: "Credit" },
    { date: "2026-01-10", category: "Income", amount: 5400, type: "Credit" },
    { date: "2026-01-11", category: "Income", amount: 5800, type: "Credit" },
  ];
      ...
      <Tabs defaultValue="30-days" className="flex flex-col gap-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <ExportButton data={transactionsData} filename="finance-report" />
          </div>
        </div>
