  ...
  const processFile = async () => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setValidationResult({ errors: [{ row: 0, field: "system", error: data.error || "Unknown error" }] });
      }
    } catch (err: any) {
      console.error(err);
  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {validationResult && (
          <Card className={validationResult.isValid ? "border-green-500/50" : "border-red-500/50"}>
            <CardHeader>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-muted/50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{validationResult.totalRows || 0}</p>
                  </div>
                  <div className="bg-muted/50 p-4 rounded-lg">
