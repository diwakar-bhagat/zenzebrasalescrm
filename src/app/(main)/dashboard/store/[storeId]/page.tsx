...
function GrowthBadge({ growth }: { growth: number | "NEW STORE" }) {
	if (growth === "NEW STORE") {
		return (
			<span className="text-xs font-medium text-blue-500 bg-blue-500/10 px-1.5 py-0.5 rounded-full">
				New
			</span>
		);
	}
...
function DiagnosisBadge({ type }: { type: string }) {
	const map: Record<string, { label: string; color: string }> = {
		HEALTHY: { label: "Healthy", color: "text-emerald-600 bg-emerald-500/10" },
						...
						<CardContent>
							{loading ? (
								...
								<dl className="space-y-2 text-sm">
									...
									<div className="flex justify-between">
										<dt className="text-muted-foreground">Run Rate / Day</dt>
										<dd className="font-semibold">
									...
									<div className="flex justify-between">
										<dt className="text-muted-foreground">Working Days Left</dt>
										<dd className="font-semibold">
									...
									<div className="flex justify-between">
										...
										<dd className="font-semibold capitalize text-xs">
							...
							{loading ? (
								...
								<dl className="space-y-3 text-sm">
									<div>
										...
										<dd className="font-semibold">{period.current.label}</dd>
									...
									<div>
										...
										<dd className="font-semibold">{period.previous.label}</dd>
										<dd className="text-xs text-muted-foreground">
