...
/**
 * POST /api/webhooks/odoo/inventory — not implemented.
 *
...
const MESSAGE =
	"The inventory webhook is not implemented. Its backing tables do not exist and no part of the application reads them.";
