...
/**
 * POST /api/webhooks/odoo/purchase — not implemented.
 *
...
const MESSAGE =
	"The purchase webhook is not implemented. Its backing tables do not exist and no part of the application reads them.";
