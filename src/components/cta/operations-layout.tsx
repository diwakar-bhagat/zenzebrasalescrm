...
export async function OperationsLayout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    ...
    >
      ...
      <SidebarInset
        className={cn(
          "relative max-h-svh overflow-y-auto bg-background/50",
      ...
      >
        ...
        <header
          className={cn(
            ...
            "[html[data-navbar-style=sticky]_&]:sticky [html[data-navbar-style=sticky]_&]:top-0 [html[data-navbar-style=sticky]_&]:z-50 [html[data-navbar-style=sticky]_&]:overflow-hidden [html[data-navbar-style=sticky]_&]:rounded-t-[inherit] [html[data-navbar-style=sticky]_&]:bg-background/70 backdrop-blur-[8px]",
          )}
        >
        ...
        <div className="bg-surface-1 p-4 md:p-6">{children}</div>
      </SidebarInset>
    </SidebarProvider>
  );
}
