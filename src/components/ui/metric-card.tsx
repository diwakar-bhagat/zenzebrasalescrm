...
export function MetricCard({
	...
	return (
		<div
			className={cn(
				"relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 dark:bg-black/20 p-5 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] flex flex-col gap-2 transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)] hover:-translate-y-0.5",
				className,
			)}
			{...props}
		>
			<div className="flex items-center justify-between text-muted-foreground">
				...
				{Icon && (
					<div className="p-2 rounded-lg bg-white/5 border border-white/5 text-foreground/75">
