...
export const tokens = {
  ...
  effects: {
    glass: "backdrop-blur-xl bg-white/5 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.12)]",
    glassHover: "transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)] hover:-translate-y-0.5",
    cardBase: "relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-950 p-5 shadow-none",
  },

  typography: {
    titleExecutive: "text-3xl font-bold leading-none tracking-tight text-zinc-100",
