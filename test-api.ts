...
import { GET as getDashboard } from "./src/app/api/sales/dashboard/route";
import { GET as getDashboardExtended } from "./src/app/api/sales/dashboard-extended/route";
import { GET as getStatus } from "./src/app/api/sales/status/route";
